...
// ─── Keyword propagation weights (spec v4.2) ────────────────
// These constants define how much of the BKT mastery update
// propagates from an instrument review to a linked keyword.
