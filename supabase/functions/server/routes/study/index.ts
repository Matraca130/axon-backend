 ...
 *   intelligence.ts  — GET /study-intelligence, POST /study-intelligence/analyze-batch
 */
...
import { intelligenceRoutes } from "./intelligence.ts";
...
studyRoutes.route("/", intelligenceRoutes);
