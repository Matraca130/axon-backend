...
COMMENT ON COLUMN keyword_connections.connection_type IS
  'Structured connection category: prerequisite, related, contrast, part-of, cause-effect. '
  'Distinct from relationship (free-text label). Validated in app layer, not DB enum.';
